...
class WC_Gateway_Klarna_Checkout extends WC_Gateway_Klarna {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_kco_iframe_v2_shipping_address_change_cb', array(
			$this,
			'kco_iframe_v2_shipping_address_change_cb'
		) );
		add_action( 'wp_ajax_nopriv_kco_iframe_v2_shipping_address_change_cb', array(
			$this,
			'kco_iframe_v2_shipping_address_change_cb'
		) );
		// V3
