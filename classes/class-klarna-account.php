...
class WC_Gateway_Klarna_Account extends WC_Gateway_Klarna {
	...
	function collect_dob( $order_id ) {
		...
		if ( $_POST['billing_country'] == 'NL' || $_POST['billing_country'] == 'DE' ) {
			...
			$klarna_pno = 
				isset( $_POST['klarna_account_pno'] ) ? woocommerce_clean( $_POST['klarna_account_pno'] ) : '';
		}
	...
	function process_payment( $order_id ) {
		...
		$klarna_pclass = 
			isset( $_POST['klarna_account_pclass'] ) ? woocommerce_clean( $_POST['klarna_account_pclass'] ) : '';
		$klarna_gender = 
			isset( $_POST['klarna_account_gender'] ) ? woocommerce_clean( $_POST['klarna_account_gender'] ) : '';
